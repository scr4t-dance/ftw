...
val convert_singles_heat_to_couples_heat : st:State.t -> phase:target_id -> target_id -> target_id list
val convert_couples_heat_to_singles_heat : st:State.t -> phase:target_id -> target_id -> target_id list
val mix_couples :
  st:State.t ->
  phase:target_id ->
  target_id ->
