...
let compute_promotion st (result : Results.r) =
  ...
  let sorted_previous_comps = List.sort (fun (r1:Results.r) (r2:Results.r) ->
      Date.compare (get_comp_date r1.competition) (get_comp_date r2.competition)) previous_comps in
