function RulesV2() {
    return (
        <>
            ...
            <p>
                Passé l'événement de mise en place du système (Printemps 4 Temps 2022, voir <a href="/rules/0">les anciennes règles</a>), l'accès à une division donnée est déterminé par le nombre de points SCR4T accumulés dans une division, indiqués dans le tableau ci-dessous :
            </p>
            <table>
                <thead>
                    <tr>
            ...
            <table className="large-table">
                <thead>
                    <tr>
                        ...
                        <th>9ème place</th>
                        <th>10ème place</th>
                        <th>11ème à 14ème place</th>
                        <th>Demi-finaliste</th>
                    </tr>
                </thead>
                <tbody>
                    <tr className="even-row">
                        <td>Tier 1 : de 5 à 10 p.</td>
                        <td>6</td>
                        <td>4</td>
                        <td>2</td>
                        <td>-</td>
