...
function RulesV1() {
    return (
        <>
            ...
            <p>
                Passé l'événement de mise en place du système (Printemps 4 Temps 2022, voir <Link to="/rules/0">les anciennes règles</Link>), l'accès à une division donnée est déterminé par le nombre de points SCR4T accumulés dans une division, indiqués dans le tableau ci-dessous :
            </p>
            <table>
                <thead>
                    <tr>
